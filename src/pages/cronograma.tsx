  ...
  return (
    <>
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            <h1 className="text-center text-3xl font-medium">Cronograma</h1>
            {/* container com altura que sobrar */}
            <div className="container mx-auto flex flex-row items-center justify-center gap-4">
              <ColComponent name="Treino A" lines={5} />
              <ColComponent name="Treino B" lines={5} />
              <ColComponent name="Treino C" lines={5} />
              <ColComponent name="Treino D" lines={5} />
            </div>
          </div>
